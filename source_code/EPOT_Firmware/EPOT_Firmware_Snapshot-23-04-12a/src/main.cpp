...
void setup() {
  ...
  Serial.println("Firmware 12/04/23a (c)2023 Arnaud LE COSSEC");
  ...
  char Msg[17] = {};
  if(Bluetooth_Receive_String(Msg, 17, BLUETOOTH_TIMEOUT)){goto l_initial_configuration;}
  if(compare_tables(Msg_Ref, Msg, 17)==false){Serial.print("[ERR] Hello mismatch"); goto l_initial_configuration;};
